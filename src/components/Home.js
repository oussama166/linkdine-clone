...
function Home() {
  // Prevent user to back the the login page or signup page when he is alredy connect

  // End Prevent user to back the login page or signup page when he is alredy connect
      ...
      <main className="h-full pt-24 mx-[20px] grid grid-cols-12 gap-4">
        ...
        <div className="row-span-full col-span-3 flex flex-col">
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full ring-1 ring-gray-300 overflow-hidden">
            {/* Cover and Profile */}
            <div className={`w-[266px] h-28 relative rounded-t-md`}>
            ...
            <div className="w-full flex flex-col items-center my-4">
              ...
              {/* When I must click here he must send me to self profil */}
            ...
            <div className="w-full flex flex-row items-start justify-between my-2 py-5 px-3 cursor-pointer hover:bg-gray-200">
              <div className=" flex flex-col ">
                ...
                <span className="text-sm text-gray-900 font-semibold">
                  Devlopper votre relations
                </span>
              </div>
              <span className="text-sm text-blue-500">19</span>{" "}
              {/* This label show how much contact that i have  */}
            </div>
            <Divider />
            {/* Mes Elements */}
            <div className="w-full flex flex-row items-start justify-between my-2 py-5 px-3  cursor-pointer hover:bg-gray-200">
              <div className=" flex items-center gap-4">
                ...
                <span className="text-sm text-gray-n400 font-semibold">
                  Mes elements
                </span>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full ring-1 ring-gray-300 mt-4">
            ...
            <div className="w-full flex flex-col items-start gap-3 my-4 px-3">
              <span className="font-semibold text-sm text-blue-500 hover:underline transition-all cursor-pointer ease-in-out ">
                Groups
              </span>
          ...
          <div className="w-full flex flex-col items-start gap-3  bg-white p-3 rounded-xl">
            ...
            <div className="w-full flex flex-row items-center justify-between">
              <div className="utilsButton">
                <HiPhotograph className="text-blue-500" size={25} />
                Photo
              </div>
              <div className="utilsButton">
        ...
        {/* Right side */}
        <div className="col-span-3 bg-white rounded-2xl shadow-xl"></div>
      </main>
    </ThemeProvider>
  );
}
